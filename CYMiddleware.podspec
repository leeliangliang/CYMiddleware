...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NobLee/CYMiddleware'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NobLee' => 'liang554166037@163.com' }
  s.source           = { :git => 'https://github.com/NobLee/CYMiddleware.git', :tag => s.version.to_s }
